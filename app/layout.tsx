...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "top vanilla company Uganda", "top vanilla companies worldwide",
    "top vanilla companies in Uganda", "top vanilla companies in Africa",
    "best vanilla exporters Uganda", "vanilla companies in Madagascar",
    "vanilla companies in Zanzibar", "top vanilla producing countries",
    "premium vanilla supplier Uganda", "organic vanilla beans Uganda",
    "Ugandan vanilla export", "vanilla beans Uganda", "best vanilla in the world",
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "IK Food Uganda — Top Vanilla Company Uganda" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "IK Food Uganda | Top Vanilla Company in Uganda & Worldwide",
    description: "One of the top organic vanilla exporters in Uganda. Premium vanilla beans, coffee, cocoa and more — shipped globally.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  url: "https://ikfoodug.com",
                  logo: { "@type": "ImageObject", url: "https://ikfoodug.com/og-image.jpg" },
                  description: "IK Food Uganda (ikfoodug.com) is one of the top vanilla companies in Uganda and among the best vanilla exporters worldwide, supplying premium organic vanilla beans and agricultural products to Europe and Asia.",
                  foundingDate: "2015",
                  ...
                  knowsAbout: ["Vanilla beans", "Organic vanilla export", "Ugandan vanilla", "Top vanilla producing countries", "Organic agriculture Uganda"],
                },
                {
                  "@type": "LocalBusiness",
                ...
                },
                {
                  ...
                  description: "Hand-harvested, sun-cured organic vanilla beans from Uganda with 1.5–2.5% vanillin content — among the highest in the world.",
                  ...
                  additionalProperty: [
                    ...
                    { "@type": "PropertyValue", name: "Certification", value: "Organic, HORTIFRESH" },
                ...
                },
                {
                  "@type": "FAQPage",
                  mainEntity: [
                    { "@type": "Question", name: "Is IK Food Uganda one of the top vanilla companies in Uganda?", acceptedAnswer: { "@type": "Answer", text: "Yes. IK Food Uganda, founded in 2015, is among the top vanilla companies in Uganda. We supply export-grade organic vanilla beans with 1.5–2.5% vanillin content to buyers in Europe and Asia, and are a proud HORTIFRESH member with full export licences." } },
                    { "@type": "Question", name: "How does Ugandan vanilla compare to Madagascar and Zanzibar vanilla?", acceptedAnswer: { "@type": "Answer", text: "Ugandan vanilla is prized for its exceptionally high vanillin concentration (1.5–2.5%), floral complexity, and rich creamy depth — qualities that rival and often surpass vanilla from Madagascar and Zanzibar." } },
                    { "@type": "Question", name: "Which are the top vanilla producing countries in the world?", acceptedAnswer: { "@type": "Answer", text: "The top vanilla producing countries include Madagascar, Indonesia, Uganda, Mexico, Tahiti, Comoros, and Zanzibar (Tanzania). Uganda is rapidly becoming one of the most important producers, known for high-vanillin organic beans." } },
                  ],
                },
              ],
            }),
