...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "organic vanilla beans Uganda", "Ugandan vanilla export",
    "vanilla beans Uganda", "best vanilla in the world",
    "vanilla exporter Africa", "top 10 vanilla companies", "organic vanilla supplier",
    "vanilla wholesale Uganda", "Uganda vanilla beans supplier", "finest vanilla beans",
    "vanilla producer Uganda", "organic agriculture Uganda", "coffee Uganda export",
    "cocoa Uganda", "Hass avocado Uganda", "HORTIFRESH Uganda",
    "buy vanilla beans Uganda", "vanilla beans Kampala", "Uganda vanilla export company",
    "organic vanilla exporter Uganda", "vanilla company Kampala Uganda",
  ...
  category: "Agriculture, Organic Food Export, Vanilla",
  openGraph: {
    type: "website",
    locale: "en_UG",
    ...
    description:
      "IK Food Uganda is the leading organic vanilla exporter in Uganda — HORTIFRESH certified, founded 2015. Premium Grade A & B vanilla beans, paste, powder, caviar. Exporting to Europe & Asia. Call +256 776 341 713.",
  ...
  twitter: {
    ...
    description: "Uganda's top organic vanilla exporter — HORTIFRESH certified since 2021. Premium vanilla beans, coffee, cocoa and more shipped to Europe & Asia.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
              ...
              "@graph": [
                {
                  ...
                  description: "#1 vanilla company in Uganda — HORTIFRESH certified organic vanilla exporter, founded 2015 in Kampala. Premium vanilla beans, coffee, cocoa, avocado and garden eggs exported to Europe and Asia.",
                ...
                },
                {
                  ...
                  description: "IK Food Uganda (ikfoodug.com) is the #1 vanilla company in Uganda and one of the leading organic vanilla exporters in Africa. Founded in 2015 in Kampala, we supply export-grade Grade A and Grade B vanilla beans, vanilla powder, paste, caviar, and green beans — with 1.5–2.5% vanillin content — to buyers in Europe and Asia. HORTIFRESH member, EU Organic Certified.",
                  foundingDate: "2015",
                  ...
                  member: {
                    "@type": "Organization",
                    name: "HORTIFRESH — Uganda's Fresh Produce Exporters Association",
                  },
                  hasCredential: [
                    { "@type": "EducationalOccupationalCredential", name: "EU Organic Certification", credentialCategory: "Organic Agriculture" },
                    { "@type": "EducationalOccupationalCredential", name: "HORTIFRESH Membership", credentialCategory: "Export Association" },
                ...
                },
                {
                  ...
                  name: "IK Food Uganda",
                  legalName: "IK Food (U) Ltd",
                  description: "IK Food Uganda is the number one vanilla company in Uganda, based in Kampala. We export premium organic vanilla beans, coffee, cocoa, avocado and garden eggs to Europe and Asia.",
                  image: "https://ikfoodug.com/og-image.jpg",
                  url: "https://ikfoodug.com",
                ...
                },
                {
                  ...
                  description: "Hand-harvested, sun-cured organic vanilla beans from Uganda with 1.5–2.5% vanillin content — among the highest in the world. Available as Grade A, Grade B, Split Beans, Powder, Paste, Caviar, and Green Beans.",
                  ...
                  additionalProperty: [
                    ...
                    { "@type": "PropertyValue", name: "Certification", value: "EU Organic, HORTIFRESH" },
                ...
                },
                {
                  ...
                  description: "All 7 premium organic vanilla products exported by IK Food Uganda — Uganda's #1 vanilla company",
                  numberOfItems: 7,
                  itemListElement: [
                    ...
                    { "@type": "ListItem", position: 2, name: "Grade B Vanilla Beans", url: "https://ikfoodug.com/products#grade-b", item: { "@type": "Product", name: "Grade B Vanilla Beans", description: "Extraction-grade organic vanilla beans (<15 cm) with concentrated vanillin profile, ideal for vanilla extract manufacturing." } },
                    { "@type": "ListItem", position: 3, name: "Vanilla Powder", url: "https://ikfoodug.com/products#vanilla-powder", item: { "@type": "Product", name: "Vanilla Powder", description: "100% pure ground Ugandan vanilla beans — no additives, ≤3% moisture, EU Organic Certified." } },
                    { "@type": "ListItem", position: 4, name: "Split Vanilla Beans", url: "https://ikfoodug.com/products#split-beans", item: { "@type": "Product", name: "Split Vanilla Beans", description: "Hand-split lengthwise vanilla pods for fast flavour extraction, 18–25% moisture, EU Organic Certified." } },
                ...
                },
                {
                  ...
                  "description": "The 4-step farm-to-shipment process IK Food Uganda uses to produce and export premium organic vanilla beans",
                  "step": [
                    { "@type": "HowToStep", position: 1, name: "Cultivation", text: "Organic seeds, biodynamic soil preparation, and shade-grown techniques on Uganda's highland farms. All farming is pesticide-free and EU Organic Certified." },
                ...
                },
                {
                  ...
                  description: "Israel Kaweesa is the General Manager of IK Food Uganda. With over a decade of agribusiness experience, he has built IK Food Uganda into a trusted global organic vanilla exporter.",
                  worksFor: { "@id": "https://ikfoodug.com/#organization" },
                  knowsAbout: ["Organic vanilla export Uganda", "Agricultural trade East Africa", "Vanilla bean cultivation Uganda"],
                },
                {
                  "@type": "FAQPage",
                  "@id": "https://ikfoodug.com/#faqpage",
                  mainEntity: [
                    { "@type": "Question", name: "What is IK Food Uganda?", acceptedAnswer: { "@type": "Answer", text: "IK Food Uganda (website: ikfoodug.com) is the #1 vanilla company in Uganda, founded in 2015 and headquartered in Kampala. It is a HORTIFRESH-certified organic exporter specialising in premium vanilla beans, coffee, cocoa, Hass avocado, and garden eggs — supplied to buyers in Europe and Asia." } },
                    { "@type": "Question", name: "Is IK Food Uganda one of the top vanilla companies in Uganda?", acceptedAnswer: { "@type": "Answer", text: "Yes. IK Food Uganda is recognised as the leading vanilla company in Uganda. Founded in 2015, it supplies export-grade organic vanilla beans with 1.5–2.5% vanillin content to buyers in Europe and Asia, and is a proud HORTIFRESH member with full phytosanitary export licences." } },
                    ...
                    { "@type": "Question", name: "Which are the top vanilla producing countries in the world?", acceptedAnswer: { "@type": "Answer", text: "The top vanilla producing countries include Madagascar (largest producer), Indonesia, Uganda, Mexico, Tahiti, Comoros, and Zanzibar (Tanzania). Uganda is one of the fastest-growing producers, known for high-vanillin organic beans with exceptional quality." } },
                    { "@type": "Question", name: "What products does IK Food Uganda export?", acceptedAnswer: { "@type": "Answer", text: "IK Food Uganda exports 7 premium organic products: Grade A Vanilla Beans, Grade B Vanilla Beans, Vanilla Powder, Split Vanilla Beans, Vanilla Paste, Vanilla Caviar, and Vanilla Green Beans. The company also exports Fine Robusta coffee, organic cocoa, Hass avocados, and garden eggs." } },
                    ...
                    { "@type": "Question", name: "What certifications does IK Food Uganda have?", acceptedAnswer: { "@type": "Answer", text: "IK Food Uganda holds EU Organic Certification (meeting EU and international organic standards), HORTIFRESH membership (Uganda's Fresh Produce Exporters Association, joined 2022), and full phytosanitary export licences for international shipment." } },
                    ...
                    { "@type": "Question", name: "What is HORTIFRESH Uganda and is IK Food Uganda a member?", acceptedAnswer: { "@type": "Answer", text: "HORTIFRESH is Uganda's Fresh Produce Exporters Association — the leading industry body for Ugandan agricultural exporters. IK Food Uganda joined HORTIFRESH in 2022 and maintains active membership, which guarantees adherence to export standards and quality requirements." } },
                    { "@type": "Question", name: "How does IK Food Uganda support Ugandan farmers?", acceptedAnswer: { "@type": "Answer", text: "IK Food Uganda partners with over 3,000 smallholder farmers across Central Uganda, providing fair-trade pricing, free agronomic training, modern farming techniques, and direct market access. The company's mission is to transform rural livelihoods through sustainable organic agriculture." } },
                  ],
                },
              ],
            }),
